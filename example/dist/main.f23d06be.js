...
},{"./runtime":"node_modules\\regenerator-runtime\\runtime.js"}],"node_modules\\vue\\dist\\vue.runtime.esm.js":[function(require,module,exports) {
var global = arguments[3];
'use strict';
...
},{"./bundle-url":"..\\node_modules\\parcel\\src\\builtins\\bundle-url.js"}],"..\\node_modules\\vue-hot-reload-api\\dist\\index.js":[function(require,module,exports) {
var Vue // late bind
var version
...
exports.default = {
  ...
  methods: {
    beforeSend: function beforeSend(opts) {
      console.log('beforeSend', opts);
      opts[1].method = 'PUT';
    },
    ...
    onComplete: function onComplete() {
      console.log('oncomplete', arguments);
        ...
        var $9b3d46 = exports.default || module.exports;
      
      if (typeof $9b3d46 === 'function') {
        $9b3d46 = $9b3d46.options;
      }
    
        /* template */
        Object.assign($9b3d46, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c(
    ...
    [
      _c("input", {
        attrs: { type: "text", name: "txt", value: "Tiếng Việt có dấu" }
      }),
      _vm._v(" "),
      _c("br"),
      _vm._v(" "),
      _c("input", { attrs: { type: "file", name: "field_name" } }),
      _vm._v(" "),
      _c("br"),
      _vm._v(" "),
      _c("input", { attrs: { type: "submit", name: "submit", value: "OK" } })
    ]
  )
}
var staticRenderFns = []
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$9b3d46', $9b3d46);
          } else {
            api.reload('$9b3d46', $9b3d46);
          }
        }
...
},{"_css_loader":"..\\node_modules\\parcel\\src\\builtins\\css-loader.js","vue-hot-reload-api":"..\\node_modules\\vue-hot-reload-api\\dist\\index.js","vue":"node_modules\\vue\\dist\\vue.runtime.esm.js"}],"..\\node_modules\\pnotify\\dist\\umd\\PNotify.js":[function(require,module,exports) {
var define;
...
!function (t, e) {
  ...
  var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {};(function (P) {
    !function (t) {
      var u,
          ...
          a = t.regeneratorRuntime;if (a) P.exports = a;else {
        (a = t.regeneratorRuntime = P.exports).wrap = b;var s = "suspendedStart",
            h = "suspendedYield",
            y = "executing",
            l = "completed",
            m = {},
          ...
          return this;
            ...
            d = c && c(c(O([])));d && d !== e && p.call(d, i) && (f = d);var g = k.prototype = w.prototype = Object.create(f);x.prototype = g.constructor = k, k.constructor = x, k[n] = x.displayName = "GeneratorFunction", a.isGeneratorFunction = function (t) {
          var e = "function" == typeof t && t.constructor;return !!e && (e === x || "GeneratorFunction" === (e.displayName || e.name));
        }, a.mark = function (t) {
          return Object.setPrototypeOf ? Object.setPrototypeOf(t, k) : (t.__proto__ = k, n in t || (t[n] = "GeneratorFunction")), t.prototype = Object.create(g), t;
        }, a.awrap = function (t) {
          return { __await: t };
        }, E(L.prototype), L.prototype[o] = function () {
          return this;
        }, a.AsyncIterator = L, a.async = function (t, e, r, o) {
          var i = new L(b(t, e, r, o));return a.isGeneratorFunction(e) ? i : i.next().then(function (t) {
            return t.done ? t.value : i.next();
          });
        }, E(g), g[n] = "Generator", g[i] = function () {
          return this;
        }, g.toString = function () {
          return "[object Generator]";
        }, a.keys = function (r) {
          var o = [];for (var t in r) {
            o.push(t);
          }return o.reverse(), function t() {
            for (; o.length;) {
              var e = o.pop();if (e in r) return t.value = e, t.done = !1, t;
            }return t.done = !0, t;
          };
        }, a.values = O, C.prototype = { constructor: C, reset: function reset(t) {
            if (this.prev = 0, this.next = 0, this.sent = this._sent = u, this.done = !1, this.delegate = null, this.method = "next", this.arg = u, this.tryEntries.forEach(R), !t) for (var e in this) {
              "t" === e.charAt(0) && p.call(this, e) && !isNaN(+e.slice(1)) && (this[e] = u);
            }
          }, stop: function stop() {
            this.done = !0;var t = this.tryEntries[0].completion;if ("throw" === t.type) throw t.arg;return this.rval;
          }, dispatchException: function dispatchException(r) {
            var t = this;if (this.done) throw r;var o = this;function e(t, e) {
              return a.type = "throw", a.arg = r, o.next = t, e && (o.method = "next", o.arg = u), !!e;
            }for (var i = this.tryEntries.length - 1; 0 <= i; --i) {
              var n = t.tryEntries[i],
                  a = n.completion;if ("root" === n.tryLoc) return e("end");if (n.tryLoc <= t.prev) {
                var f = p.call(n, "catchLoc"),
                    c = p.call(n, "finallyLoc");if (f && c) {
                  if (t.prev < n.catchLoc) return e(n.catchLoc, !0);if (t.prev < n.finallyLoc) return e(n.finallyLoc);
                } else if (f) {
                  if (t.prev < n.catchLoc) return e(n.catchLoc, !0);
                } else {
                  if (!c) throw new Error("try statement without catch or finally");if (t.prev < n.finallyLoc) return e(n.finallyLoc);
                }
              }
            }
          }, abrupt: function abrupt(t, e) {
            for (var r = this.tryEntries.length - 1; 0 <= r; --r) {
              var o = this.tryEntries[r];if (o.tryLoc <= this.prev && p.call(o, "finallyLoc") && this.prev < o.finallyLoc) {
                var i = o;break;
              }
            }i && ("break" === t || "continue" === t) && i.tryLoc <= e && e <= i.finallyLoc && (i = null);var n = i ? i.completion : {};return n.type = t, n.arg = e, i ? (this.method = "next", this.next = i.finallyLoc, m) : this.complete(n);
            ...
            for (var e = this.tryEntries.length - 1; 0 <= e; --e) {
              var r = this.tryEntries[e];if (r.finallyLoc === t) return this.complete(r.completion, r.afterLoc), R(r), m;
            }
            ...
            return this.delegate = { iterator: O(t), resultName: e, nextLoc: r }, "next" === this.method && (this.arg = u), m;
          } };
      }function b(t, e, r, o) {
        var n,
            a,
            f,
            c,
            i = e && e.prototype instanceof w ? e : w,
            u = Object.create(i.prototype),
            p = new C(o || []);return u._invoke = (n = t, a = r, f = p, c = s, function (t, e) {
          if (c === y) throw new Error("Generator is already running");if (c === l) {
            if ("throw" === t) throw e;return _();
          }for (f.method = t, f.arg = e;;) {
            var r = f.delegate;if (r) {
              var o = j(r, f);if (o) {
                if (o === m) continue;return o;
              }
            }if ("next" === f.method) f.sent = f._sent = f.arg;else if ("throw" === f.method) {
              if (c === s) throw c = l, f.arg;f.dispatchException(f.arg);
            } else "return" === f.method && f.abrupt("return", f.arg);c = y;var i = v(n, a, f);if ("normal" === i.type) {
              if (c = f.done ? l : h, i.arg === m) continue;return { value: i.arg, done: f.done };
            }"throw" === i.type && (c = l, f.method = "throw", f.arg = i.arg);
          }
        }), u;
      }function v(t, e, r) {
        try {
      ...
      }function w() {}function x() {}function k() {}function E(t) {
        ...
        function c(t, e, r, o) {
          var i = v(f[t], f, e);if ("throw" !== i.type) {
            var n = i.arg,
                a = n.value;return a && "object" == (typeof a === "undefined" ? "undefined" : _typeof(a)) && p.call(a, "__await") ? Promise.resolve(a.__await).then(function (t) {
              c("next", t, r, o);
            }, function (t) {
              c("throw", t, r, o);
        ...
        }var e;"object" == _typeof(t.process) && t.process.domain && (c = t.process.domain.bind(c)), this._invoke = function (r, o) {
          function t() {
        ...
        var r = t.iterator[e.method];if (r === u) {
          if (e.delegate = null, "throw" === e.method) {
            if (t.iterator.return && (e.method = "return", e.arg = u, j(t, e), "throw" === e.method)) return m;e.method = "throw", e.arg = new TypeError("The iterator does not provide a 'throw' method");
          }return m;
        }var o = v(r, t.iterator, e.arg);if ("throw" === o.type) return e.method = "throw", e.arg = o.arg, e.delegate = null, m;var i = o.arg;return i ? i.done ? (e[t.resultName] = i.value, e.next = t.nextLoc, "return" !== e.method && (e.method = "next", e.arg = u), e.delegate = null, m) : i : (e.method = "throw", e.arg = new TypeError("iterator result is not an object"), e.delegate = null, m);
      }function S(t) {
        ...
        if (e) {
          var t = e[i];if (t) return t.call(e);if ("function" == typeof e.next) return e;if (!isNaN(e.length)) {
            var r = -1,
                o = function t() {
              for (; ++r < e.length;) {
                if (p.call(e, r)) return t.value = e[r], t.done = !1, t;
  ...
  }var a = require("pnotify/dist/umd/PNotifyCompat"),
      l = (require("pnotify/dist/umd/PNotifyButtons"), function t(e, r) {
    var o,
        i = [];for (o in e) {
      if (e.hasOwnProperty(o)) {
        var n = r ? r + "[" + o + "]" : o,
            a = e[o];i.push(null !== a && "object" === (void 0 === a ? "undefined" : f(a)) ? t(a, n) : encodeURIComponent(n) + "=" + encodeURIComponent(a));
      }
    }return i.join("&");
  });function m(t) {
    if (!(t instanceof Node && "FORM" === t.tagName.toUpperCase())) throw new Error("first argument is not HTMLFormElement");for (var e = null != t.querySelector('[type="file"][name]'), r = e ? new FormData() : {}, o = t.querySelectorAll("[name]"), i = 0, n = o.length; i < n; i++) {
      var a = o[i],
          f = a.getAttribute("name"),
          c = a.getAttribute("value");if (f) if (a.hasAttribute("type") && "file" === a.getAttribute("type").toLowerCase() && r instanceof FormData) for (var u = a.files, p = 0, s = u.length; p < s; p++) {
        r.append(f, u[p], u[p].webkitRelativePath ? u[p].webkitRelativePath : u[p].name);
      } else a.hasAttribute("type") && ["checkbox", "radio"].includes(a.getAttribute("type").toLowerCase()) ? a.checked && (e ? r.append(f, c) : r[f] = c) : e ? r.append(f, a.value) : r[f] = a.value;
    }return r;
  }function d(t, e, r) {
    var o = new a({ title: e, text: r, type: t, desktop: { desktop: !1 } });o.get().addEventListener("click", function (t) {
      o.remove();
    });
  }var c,
      u,
      p = (c = regeneratorRuntime.mark(function t(r) {
    var o, i, n, a, f, c, u, p, s, h;return regeneratorRuntime.wrap(function (t) {
      for (var e = this;;) {
        switch (t.prev = t.next) {case 0:
            if (o = m(r.target), "function" != typeof (i = e.validator)) {
              t.next = 18;break;
            }if (t.prev = 3, "function" != typeof (n = i(o)).catch) {
              t.next = 9;break;
            }return t.next = 8, n;case 8:
            n = t.sent;case 9:
            if (!1 !== n) {
              t.next = 11;break;
            }return t.abrupt("return");case 11:
            if (n && n instanceof Object) if (n instanceof Array) d.apply(void 0, y(n));else if (!n.success) for (a in n) {
              d(("" + a).toLowerCase(), ("" + a).toUpperCase(), "" + n[a]);
            }t.next = 18;break;case 14:
            throw t.prev = 14, t.t0 = t.catch(3), t.t0.message && d("error", "ERROR", t.t0.message), t.t0;case 18:
            return f = e.method ? e.method.toUpperCase() : "GET", c = [e.action || location.href, { method: f }], u = { Accept: "application/json, */*" }, "GET" !== f && (o instanceof FormData ? c[1].body = o : e.json && "false" !== e.json ? (u["Content-Type"] = "application/json", c[1].body = JSON.stringify(o)) : (c[1].body = l(o), u["Content-Type"] = "application/x-www-form-urlencoded")), c[1].headers = u, "function" == typeof e.beforeSend && e.beforeSend(c), s = p = void 0, t.prev = 25, t.next = 28, fetch.apply(void 0, c);case 28:
            return s = t.sent, t.prev = 29, t.next = 32, s.json();case 32:
            p = t.sent;try {
              if (p && p instanceof Object) if (p.success) "function" == typeof e.success && e.success(p, s), d("success", "SUCCESS", "string" == typeof p.success && p.success ? p.success : "Success");else for (h in p) {
                d(("" + h).toLowerCase(), ("" + h).toUpperCase(), "" + p[h]);
              }
            } catch (t) {}t.next = 41;break;case 36:
            t.prev = 36, t.t1 = t.catch(29), console.error("auto-form", t.t1), t.t1.message && d("error", "ERROR", t.t1.message), "function" == typeof e.error && e.error(p, s);case 41:
            t.next = 47;break;case 43:
            t.prev = 43, t.t2 = t.catch(25), t.t2.message && d("error", "ERROR", t.t2.message), "function" == typeof e.error && e.error(t.t2, s);case 47:
            "function" == typeof e.complete && e.complete(p, s);case 48:case "end":
            return t.stop();}
      }
    }, t, this, [[3, 14], [25, 43], [29, 36]]);
  }), u = function u() {
    var f = c.apply(this, arguments);return new Promise(function (n, a) {
    ...
    return u.apply(this, arguments);
      ...
      var e = this,
          t = e.$createElement;return (e._self._c || t)("form", { on: { submit: function submit(t) {
            return t.preventDefault(), e.onSubmit(t);
          } } }, [e._t("default")], 2);
    }, staticRenderFns: [], props: { method: { type: String, required: !1, default: "GET", validator: function validator(t) {
          return ["GET", "POST", "PUT", "DELETE", "PATCH"].includes(t.toUpperCase());
        } }, action: { type: String, required: !1 }, json: { default: !1 }, validator: { type: Function, required: !1 }, httpagent: { type: Function, required: !1 }, success: { type: Function, required: !1 }, error: { type: Function, required: !1 }, complete: { type: Function, required: !1 }, beforeSend: { type: Function, required: !1 } }, methods: { onSubmit: function onSubmit(t) {
        p.call(this, t);
      } } };function h(t, e) {
    t.component("auto-form", s);
  }var g = "1.0.0",
      b = { install: h, version: g };t.install = h, t.version = g, t.default = b, Object.defineProperty(t, "__esModule", { value: !0 });
});
},{"pnotify/dist/umd/PNotifyCompat":"..\\node_modules\\pnotify\\dist\\umd\\PNotifyCompat.js","pnotify/dist/umd/PNotifyButtons":"..\\node_modules\\pnotify\\dist\\umd\\PNotifyButtons.js"}],"main.js":[function(require,module,exports) {
'use strict';
  ...
  return new _vue2.default({
    ...
    methods: {
      log: function log() {
        ...
        (_console = console).log.apply(_console, ['app.log:'].concat(_toConsumableArray(t)));
      },
      error: function error() {
        ...
        (_console2 = console).error.apply(_console2, ['app.log:'].concat(_toConsumableArray(t)));
      }
    }
  }).$mount('#app');
}
...
},{"regenerator-runtime":"node_modules\\regenerator-runtime\\runtime-module.js","vue":"node_modules\\vue\\dist\\vue.runtime.esm.js","./App.vue":"App.vue","../":"..\\dist\\vue-auto-form.js"}],"..\\node_modules\\parcel\\src\\builtins\\hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/main.f23d06be.map